  ...
  const handleSubmit = useCallback(async (e) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        setError(data.error || 'The username you entered doesn\'t belong to an account. Please check your username and try again.');
      }
    } catch (err) {
  ...
  return (
    <div className="instagram-login-wrapper">
      <div className="instagram-login-content">
        ...
        <button type="button" onClick={onCancel} className="instagram-back-btn">
        ...
        <div className="instagram-card">
          ...
          <form onSubmit={handleSubmit} className="instagram-form">
            ...
            {error && <div className="instagram-error-msg">{error}</div>}
        ...
        {/* Sign up box */}
        <div className="instagram-signup-card">
          <p>
            Don't have an account? 
            <a href="#" className="instagram-signup-link" onClick={(e) => { e.preventDefault(); alert('Account signup is disabled in sandbox mode.'); }}>
              Sign up
            </a>
          </p>
        </div>
        ...
        <div className="instagram-get-app">
          <p>Get the app.</p>
          <div className="instagram-badges">
            <img 
              src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg" 
              alt="Get it on Google Play" 
              className="instagram-badge-img"
            ...
            <img 
              ...
              className="instagram-badge-img"
              onClick={() => window.open('https://apps.apple.com/app/instagram/id389801252', '_blank')}
            />
          </div>
        </div>
        ...
        <footer className="instagram-footer">
          <div className="instagram-footer-links">
            <a href="#">Meta</a>
            <a href="#">About</a>
            <a href="#">Blog</a>
            <a href="#">Jobs</a>
          ...
          <div className="instagram-footer-copyright">
